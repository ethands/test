 ...
 * Note that an implementer is responsible for calling {@link PeerGroup#recalculateFastCatchupAndFilter(com.mvc.bitcoincashj.core.PeerGroup.FilterRecalculateMode)}
