...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link com.mvc.bitcoincashj.store.SPVBlockStore} or you could also try a
     * {@link com.mvc.bitcoincashj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
