...
import com.mvc.bitcoincashj.net.StreamConnection;
 ...
 * {@link com.mvc.bitcoincashj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.mvc.bitcoincashj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.mvc.bitcoincashj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link com.mvc.bitcoincashj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link com.mvc.bitcoincashj.core.TxConfidenceTable}
     ...
     * Once the pong is received the value returned by {@link com.mvc.bitcoincashj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.mvc.bitcoincashj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.mvc.bitcoincashj.core.Peer#ping()} has never
