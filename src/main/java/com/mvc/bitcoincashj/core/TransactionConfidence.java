 ...
 *
 * <p>TransactionConfidence is updated via the {@link com.mvc.bitcoincashj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link com.mvc.bitcoincashj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link com.mvc.bitcoincashj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link com.mvc.bitcoincashj.core.TransactionConfidence#getConfidenceType()}
     ...
     * and so on. This information is useful for {@link com.mvc.bitcoincashj.wallet.CoinSelector} implementations to risk analyze
