...
package com.mvc.bitcoincashj.core;
...
import com.mvc.bitcoincashj.crypto.DRMWorkaround;
import com.mvc.bitcoincashj.net.BlockingClientManager;
import com.mvc.bitcoincashj.net.ClientConnectionManager;
import com.mvc.bitcoincashj.net.FilterMerger;
import com.mvc.bitcoincashj.net.NioClientManager;
import com.mvc.bitcoincashj.net.discovery.*;
import com.mvc.bitcoincashj.script.Script;
import com.mvc.bitcoincashj.utils.ContextPropagatingThreadFactory;
import com.mvc.bitcoincashj.utils.ExponentialBackoff;
import com.mvc.bitcoincashj.utils.ListenerRegistration;
import com.mvc.bitcoincashj.utils.Threading;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * {@link com.mvc.bitcoincashj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link com.mvc.bitcoincashj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.mvc.bitcoincashj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.mvc.bitcoincashj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.mvc.bitcoincashj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link com.mvc.bitcoincashj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link com.mvc.bitcoincashj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link com.mvc.bitcoincashj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.mvc.bitcoincashj.core.Peer#ping()}.
     */
