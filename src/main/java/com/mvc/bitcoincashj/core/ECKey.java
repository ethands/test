...
import com.mvc.bitcoincashj.bitcoin.NativeSecp256k1;
import com.mvc.bitcoincashj.bitcoin.NativeSecp256k1Util;
import com.mvc.bitcoincashj.bitcoin.Secp256k1Context;
import com.mvc.bitcoincashj.crypto.*;
import com.mvc.bitcoincashj.wallet.Protos;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws com.mvc.bitcoincashj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link com.mvc.bitcoincashj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link com.mvc.bitcoincashj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * @throws com.mvc.bitcoincashj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link com.mvc.bitcoincashj.core.DumpedPrivateKey#toString()} method to get the string.
     *
