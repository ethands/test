...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws com.mvc.bitcoincashj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws com.mvc.bitcoincashj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(com.mvc.bitcoincashj.crypto.KeyCrypter,
