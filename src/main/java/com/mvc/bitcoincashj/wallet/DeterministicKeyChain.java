...
import com.mvc.bitcoincashj.core.BloomFilter;
 ...
 * {@link com.mvc.bitcoincashj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.mvc.bitcoincashj.crypto.MnemonicCode},
 ...
 * {@link com.mvc.bitcoincashj.crypto.DeterministicKey#serializePubB58(com.mvc.bitcoincashj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.mvc.bitcoincashj.crypto.DeterministicKey#deserializeB58(com.mvc.bitcoincashj.crypto.DeterministicKey, String, com.mvc.bitcoincashj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.mvc.bitcoincashj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.mvc.bitcoincashj.crypto.DeterministicHierarchy} and
 * {@link com.mvc.bitcoincashj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.mvc.bitcoincashj.crypto.DeterministicKey)}
     ...
     * @see com.mvc.bitcoincashj.wallet.MarriedKeyChain
     */
