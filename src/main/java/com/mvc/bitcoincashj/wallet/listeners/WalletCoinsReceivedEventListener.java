...
package com.mvc.bitcoincashj.wallet.listeners;
...
public interface WalletCoinsReceivedEventListener {
     ...
     * the object retrieved via {@link com.mvc.bitcoincashj.core.Transaction#getConfidence()}. It's safe to modify the
