...
/**
 * <p>A KeyChainGroup is used by the {@link com.mvc.bitcoincashj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws com.mvc.bitcoincashj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.mvc.bitcoincashj.crypto.KeyCrypterScrypt}.
     *
     * @throws com.mvc.bitcoincashj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
