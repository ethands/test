...
import com.mvc.bitcoincashj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(com.mvc.bitcoincashj.crypto.KeyCrypter, KeyParameter)} with
     * {@link com.mvc.bitcoincashj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link com.mvc.bitcoincashj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
