...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.mvc.bitcoincashj.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.mvc.bitcoincashj.crypto.MnemonicException if check fails
     */
