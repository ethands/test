...
package com.mvc.bitcoincashj.wallet;
...
import com.mvc.bitcoincashj.bitcoin.protocols.payments.Protos.*;
import com.mvc.bitcoincashj.core.*;
import com.mvc.bitcoincashj.core.TransactionConfidence.*;
import com.mvc.bitcoincashj.core.listeners.*;
import com.mvc.bitcoincashj.crypto.*;
import com.mvc.bitcoincashj.script.*;
import com.mvc.bitcoincashj.signers.*;
import com.mvc.bitcoincashj.utils.*;
import com.mvc.bitcoincashj.wallet.Protos.Wallet.*;
import com.mvc.bitcoincashj.wallet.WalletTransaction.*;
import com.mvc.bitcoincashj.wallet.listeners.*;
 ...
 * {@link Wallet#autosaveToFile(File, long, TimeUnit, com.mvc.bitcoincashj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.mvc.bitcoincashj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.mvc.bitcoincashj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /** Replace with {@link #importKeys(List)}, which does the same thing but with a better name. */
    @Deprecated
     ...
     * If {@link Wallet#autosaveToFile(File, long, TimeUnit, com.mvc.bitcoincashj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link com.mvc.bitcoincashj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.mvc.bitcoincashj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.mvc.bitcoincashj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws com.mvc.bitcoincashj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.mvc.bitcoincashj.crypto.KeyCrypter,
     ...
     * {@link com.mvc.bitcoincashj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link com.mvc.bitcoincashj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link com.mvc.bitcoincashj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.mvc.bitcoincashj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.mvc.bitcoincashj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws com.mvc.bitcoincashj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
