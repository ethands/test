...
import com.mvc.bitcoincashj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable coin value to a {@link com.mvc.bitcoincashj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link com.mvc.bitcoincashj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
